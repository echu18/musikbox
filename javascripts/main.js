...
//   camera = new THREE.PerspectiveCamera(55,window.innerWidth/window.innerHeight,45,30000);
  ...
  let albumArray = [];
  // album art
  albumTexture = new THREE.TextureLoader().load( albumPath);
  // album_texture = new THREE.TextureLoader().load( 'images/ellie/posx.jpg');
  ...
  for (let i = 0; i < 6; i++) {
    albumArray.push(new THREE.MeshBasicMaterial( { map: albumTexture}))
  }
